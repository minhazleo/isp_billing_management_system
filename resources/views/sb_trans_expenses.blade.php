...
@section('content')
<div class="card-box">
    <div class="modal fade" id="new-expense" tabindex="-1" role="dialog" aria-labelledby="createExpenseModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="createExpenseModal">Add new expense</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('new.expenses') }}" method="post">
                        @csrf
    ...
    <div class="card-header pd-20 mb-4 d-flex justify-content-between align-items-center">
        <h4 class="text-blue h4 m-0"><i class="icon-copy dw dw-analytics-111 mr-2"></i>Expense List</h4>
        <button type="button" class="btn btn-sm btn-danger rounded-lg m-0" data-toggle="modal" data-target="#new-expense">
            <i class="icon-copy dw dw-add-file1"></i> New Expenses
        </button>
    </div>
    <div class="pb-20">
        <table class="data-table table stripe hover nowrap" id="expenses-data-table">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($expenses as $expense)
                    <tr>
                        <td class="table-plus">{{ $expense->price }}</td>
                        <td>{{ $expense->type }}</td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <a class="dropdown-item" href="#"><i class="dw dw-eye" data-dismiss="modal" data-target="expense" data-toggle="modal"></i> View</a>
